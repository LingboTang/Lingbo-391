...
<%if (request.getParameter(".submit") != null){
	...
	conn = DriverManager.getConnection("jdbc:oracle:thin:@gwynne.cs.ualberta.ca:1521:CRS","btrinh","trinh187");
	...
	while (pic_id <= current_pic_id){
		...
		stmt.execute("commit");
		stmt.execute("update images set owner_name='"+name+"',permitted='"+permitted+"',subject='"+subject+"',place='"+place+"',description='"+desc+"'where photo_id='"+pic_id+"'");
		pic_id++;
	}
